...
;; act automatically as necessary, in accordance with your configuration.
;;
...
;; problematic file did not meet the criteria, and you wished to trigger the
;; performance improvements manually.
;;
;; It is also possible to directly use `so-long-mode' or `so-long-minor-mode'
;; (major and minor modes, respectively).  Bother of these modes are actions
